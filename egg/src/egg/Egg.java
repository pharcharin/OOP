...
class Eggs extends JPanel implements Runnable{
    ...
    static int FWIDTH=500,FHEIGHT=500;
    int in=0;
    int speed=5;
    int lifes=30;
    static Color c1=Color.PINK,c2=Color.BLUE;
    ...
    public Eggs(){
        ...
        setOpaque(false);
        try{
            setBorder(BorderFactory.createTitledBorder(null, "", TitledBorder.CENTER, TitledBorder.ABOVE_TOP, new Font("Arial", 1, 24), new Color(204, 0, 0)));
